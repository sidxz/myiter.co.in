...
if ((isset($_POST["topic"]) && isset($_POST["textarea1"]))&& strlen($_POST["topic"])>>1)
 {
	$topic=$_POST["topic"];
	...
	$query="INSERT INTO `myiter_database`.`official` (`opid`, `type`, `topic`, `details`, `time`, `postedby`, `pagerank`)
	VALUES (NULL, '$cat', '$topic', '$des', CURRENT_TIMESTAMP, '$by', '50')";
