...
<div style="text-align:right;  line-height:35px; overflow: visible;">
			...
			<font color="#ffffff" size="2"  face="Verdana">
				...
				<select name="category" style="width: 270px; height: 30px">
					<option value="news">News ( Top Story )</option>
					<option value="event">News ( Events and Alerts )</option>
					<option value="club">News ( Clubs )</option>
					...
					<option value="tips">Tips n Tricks</option>
