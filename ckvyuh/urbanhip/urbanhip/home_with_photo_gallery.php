<?php /* Template Name: Home width Photo Gallery FX */ 
...
<?php get_header(); ?>
			...
			<!-- SLIDESHOW START -->
			<div id="slideshow" style="padding-bottom:0px;">
				<?php photogalleryfx_echo_embed_code(929,579); ?>
			</div>
			<!-- SLIDESHOW END -->
			...
			<div id="content">
				...
				<div class="cont_left">
					...
					<!-- ONE POST START -->
					<?php if (have_posts()) : ?>
						<?php query_posts(array('category__not_in' => array(get_cat_id('portfolio')), 'posts_per_page' => 2, 'orderby' => 'date', 'order' => 'DESC', 'paged' => $pagenum)); ?>
