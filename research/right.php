...
<font face="Verdana, Verdana" color="#339900" size="6"><i>Most Liked :)</i></font>

<?php

echo' <div style="border-right: 0px solid #cccccc; position: absolute; top:55px; left:0px; width:245px; height: 700px; z-index: 10; line-height:30px; overflow: visible; ">';
...
$query ="SELECT *FROM `main` WHERE `type` LIKE 'research' ORDER BY pagerank DESC LIMIT 15";
