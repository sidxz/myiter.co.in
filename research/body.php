...
<div class="comp" style="position:absolute; width:650px; height:7000px; left:315px; top:15px; z-index:1000; border:none">  
	
	  <IFRAME name="center" id="center" src="center.php?id=<?PHP echo $id; ?>" allowTransparency="true" width="600" height="7000"  align="center" marginwidth="0" marginheight="0" hspace="0" vspace="0" frameborder="0" scrolling="no">
	  </IFRAME>
