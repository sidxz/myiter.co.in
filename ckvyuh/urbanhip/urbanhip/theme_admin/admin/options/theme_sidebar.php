...
HTML;
		...
		if(!empty($sidebars)){
			echo '<div class="sidebar-title">'.__('Below are the Sidebars you have created','flashxml_admin').'</div>';
			foreach($sidebars as $sidebar){
				echo '<div class="sidebar-item"><span>'.$sidebar.'</span><input type="hidden" class="sidebar-item-value" value="'.$sidebar.'"/><input type="button" class="button" value="'.__('Delete','flashxml_admin').'"/></div>';
			}
		}
...
$options = array(
	array(
		"name" => __("Sidebar",'flashxml_admin'),
		"type" => "title"
	),
	array(
		"name" => __("Sidebar",'flashxml_admin'),
		...
		array(
			"name" => __("Generate Sidebar",'flashxml_admin'),
			"desc" => __("Enter the name of sidebar you'd like to create.",'flashxml_admin'),
			"id" => "sidebars",
